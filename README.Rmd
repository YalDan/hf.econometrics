...
* Ait-Sahalia & Jacod Jump Test & Test for Jump Activity [@sahalia_analyzing_2012]
* Ait-Sahalia, Jacod & Li Jump Test [@ait-sahalia_testing_2012]
* Ait-Sahalia & Jacod variation estimation [@sahalia_analyzing_2012]
...
libraries = c("knitr","lubridate", "rms", "markdown","mime","rmarkdown","tinytex","data.table","lattice","latticeExtra","Hmisc","DT","scales","ggplot2")
...
# load the data 
DT_list <- make_data("DT_sample.csv")
DT_crypto_split_list <-  list("impute" = split_by_id(DT_list),
...
DT_jumps_crypto <- preprocess_jump_data(DT_LM_result_crypto, sign.level = 0.001)
``` 
